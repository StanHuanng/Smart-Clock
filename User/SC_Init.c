...
void SC_GPIO_Init(void)
{
	...
	GPIOInit_PB10_Struct.GPIO_Mode = GPIO_Mode_IN_PU;
	GPIOInit_PB10_Struct.GPIO_DriveLevel = 0;
	GPIO_Init(GPIOB,&GPIOInit_PB10_Struct);/*PB.10端口初始化*/
	/*GPIOInit_PB11 Struct*/GPIO_InitTypeDef GPIOInit_PB11_Struct;
	GPIOInit_PB11_Struct.GPIO_Pin = GPIO_Pin_11;
	GPIOInit_PB11_Struct.GPIO_Mode = GPIO_Mode_IN_PU;
	GPIOInit_PB11_Struct.GPIO_DriveLevel = 0;
	GPIO_Init(GPIOB,&GPIOInit_PB11_Struct);/*PB.11端口初始化*/
	...
	GPIO_Init(GPIOC,&GPIOInit_PC00_Struct);/*PC.00端口初始化*/
	/*<Generated by EasyCodeCube end>*/		
}
...
void SC_TIM1_Init(void)
{
	...
	/*EXR*/TIM_ITConfig(TIM1,TIM_IT_EXR,DISABLE);
	/*EXF*/TIM_ITConfig(TIM1,TIM_IT_EXF,DISABLE);
...
void SC_TIM2_Init(void)
{
	...
	TIM_TimeBaseInitStruct.TIM_CounterMode = TIM_CounterMode_Up;
	TIM_TimeBaseInitStruct.TIM_Preload = 64000;
	TIM_TimeBaseInitStruct.TIM_EXENX = TIM_EXENX_Disable;
...
void SC_PWM0_Init(void)
{
	...
	PWM_InitStruct.PWM_OutputChannel = PWMChannel_Less|PWM_Channel_0|PWM_Channel_1|PWM_Channel_2|PWM_Channel_3;
